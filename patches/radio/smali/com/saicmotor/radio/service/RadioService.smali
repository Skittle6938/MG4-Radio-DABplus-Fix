...
.method private handleAccOffStatus(Z)V
    ...
    # PATCH: auto-play on ACC-on transition — check preference and schedule resume
    :autoplay_check
    ...
    iget v0, p0, Lcom/saicmotor/radio/service/RadioService;->mCurrentRadioBand:I
    iget-object v3, p0, Lcom/saicmotor/radio/service/RadioService;->mHandler:Landroid/os/Handler;
    const/4 v2, 0x4
    const-wide/16 v4, 0x12c

    if-eq v0, v2, :autoplay_dab
...
.method public synthetic lambda$onCreate$0$RadioService(I)V
    ...
    # PATCH: auto-play on first start — when CarAdapter connects, schedule resume if preference enabled
    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;
    move-result-object v0
    const-string v1, "com.saicmotor.radio.RadioStorage"
    const/4 v2, 0x0
    ...
    if-eq v0, v2, :autoplay_startup_dab
